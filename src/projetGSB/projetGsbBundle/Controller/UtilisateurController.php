...
use projetGSB\projetGsbBundle\Form\UtilisateurType;
...
class UtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('projetGSBprojetGsbBundle:Utilisateur')->findAll();

        return $this->render('projetGSBprojetGsbBundle:Utilisateur:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $entity->setMdp($encoder->encodePassword($entity->getMdp(), $entity->getSalt()));
            $em->persist($entity);
            $em->flush();
        ...
        return $this->render('projetGSBprojetGsbBundle:Utilisateur:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('projetGSBprojetGsbBundle:Utilisateur')->find($id);
        ...
        return $this->render('projetGSBprojetGsbBundle:Utilisateur:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('projetGSBprojetGsbBundle:Utilisateur:edit.html.twig', array(
            'entity'      => $entity,
